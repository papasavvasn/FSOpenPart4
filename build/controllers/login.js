...
exports.loginRouter.post('/', function (req, resp) { return __awaiter(void 0, void 0, void 0, function () {
    var body, user, passwordCorrect, _a, userForToken, token;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                body = req.body;
                return [4 /*yield*/, user_1.User.findOne({ username: body.username })];
            case 1:
                user = _b.sent();
                if (!(user === null)) return [3 /*break*/, 2];
                _a = false;
                return [3 /*break*/, 4];
            case 2: return [4 /*yield*/, bcrypt_1.default.compare(body.password, user.passwordHash)];
            case 3:
                _a = _b.sent();
                _b.label = 4;
            case 4:
